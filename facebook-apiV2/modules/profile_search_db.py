...
class Profile_db:
    ...
    def __init__(self):
        ...
        self.obj1 = ProfileSearch()
        self.obj2 = PrivateProfile()
        self.loop = asyncio.get_event_loop()


    async def private(self, q):

        self.results2 = self.obj2.fb_profile(q)
        # print(self.results2)
        print('response from private search', len(self.results2))

    async def public(self, q):

        await self.private(q)
        self.results1 = self.obj1.fb_public_search(q)
        # print(self.results1)
    ...
    def processor(self, q):
        ...
        # print(self.results2)
        # print('response from public search results1 after filtering out common pages', len(self.results1))
        # print(self.results1)
